...
const UI = {
  pt: {
    ...
    a11yHint: "Toque nas opções para adaptar a tela",
    a11yClose: "Fechar",
    a11yFontUp: "Aumentar fonte",
    a11yFontDown: "Diminuir fonte",
    a11yContrast: "Alto contraste",
    a11yGrayscale: "Escala de cinza",
    a11yUnderline: "Sublinhar links",
    a11yBigCursor: "Cursor grande",
    a11yReduceMotion: "Pausar animações",
    a11yReadingGuide: "Guia de leitura",
    a11yLibras: "Libras (VLibras)",
    a11yReset: "Restaurar padrão",
    a11yFontLevel: "Tamanho da fonte",
    adminBanner: "Você está no modo administrador. Algumas funções podem não funcionar tão bem.",
    adminBannerHint: "Pré-visualização do jogo. Envios ao painel podem falhar ou não se aplicar ao seu usuário.",
    adminPersona: "Persona",
    adminChangePersona: "Trocar persona",
    adminPickPersona: "Escolha a persona para explorar",
    adminPickPersonaHint: "Veja quantas atividades existem por trilha, idioma, ano e matéria.",
    adminTotal: "Total no catálogo",
    adminActs: "Atividades",
    adminSelect: "Entrar nesta trilha",
    adminSingle: "Escolha única",
    adminMultiple: "Múltipla escolha",
  },
  en: {
    loading: "Loading…",
    back: "Back",
    ...
    a11yHint: "Tap options to adapt the screen",
    a11yClose: "Close",
    a11yFontUp: "Larger text",
    a11yFontDown: "Smaller text",
    ...
    a11yLibras: "Sign language (VLibras)",
    a11yReset: "Reset defaults",
    a11yFontLevel: "Font size",
    adminBanner: "You are in administrator mode. Some features may not work as well.",
    adminBannerHint: "Game preview. Panel reporting may fail or not apply to your account.",
    adminPersona: "Persona",
    adminChangePersona: "Change persona",
    adminPickPersona: "Pick a persona to explore",
    adminPickPersonaHint: "See how many activities exist per track, language, year and subject.",
    adminTotal: "Catalog total",
    adminActs: "Activities",
    adminSelect: "Enter this track",
    adminSingle: "Single choice",
    adminMultiple: "Multiple choice",
  },
  es: {
    loading: "Cargando…",
    back: "Volver",
    ...
    a11yHint: "Toca las opciones para adaptar la pantalla",
    a11yClose: "Cerrar",
    a11yFontUp: "Aumentar texto",
    a11yFontDown: "Reducir texto",
    a11yContrast: "Alto contraste",
    a11yGrayscale: "Escala de grises",
    a11yUnderline: "Subrayar enlaces",
    a11yBigCursor: "Cursor grande",
    a11yReduceMotion: "Pausar animaciones",
    a11yReadingGuide: "Guía de lectura",
    a11yLibras: "Lengua de señas (VLibras)",
    a11yReset: "Restaurar",
    a11yFontLevel: "Tamaño del texto",
    adminBanner: "Estás en modo administrador. Algunas funciones pueden no funcionar tan bien.",
    adminBannerHint: "Vista previa del juego. El envío al panel puede fallar o no aplicar a tu usuario.",
    adminPersona: "Persona",
    adminChangePersona: "Cambiar persona",
    adminPickPersona: "Elige la persona para explorar",
    adminPickPersonaHint: "Mira cuántas actividades hay por trilha, idioma, año y materia.",
    adminTotal: "Total del catálogo",
    adminActs: "Actividades",
    adminSelect: "Entrar en esta trilha",
    adminSingle: "Opción única",
    adminMultiple: "Opción múltiple",
  },
};
